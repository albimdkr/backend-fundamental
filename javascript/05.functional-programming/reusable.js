...
//contoh
    const students2 = [
      ...
      **/
      ...
      //ketika kita ingin mengurutkan sesuai dengan kriteria yang kita inginkan (berdasarkan tanggal ataupun berdasarkan nilai siswa) maka kita perlu membuat compare function tersendiri.
...
for(let i = 0; i < namesImperatif.length; i++) {
  console.log(`Hello, ${namesImperatif[i]}!`);
}

//cara deklaratif
const namesDeklaratif = ['Harry', 'Ron', 'Jeff', 'Thomas'];
 
namesDeklaratif.forEach((name) => {
